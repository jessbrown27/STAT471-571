...
**Answer:** We found that there were 17 rows with at least one missing value. This likely means that these respondents didn't fill out the survey completely. Given the small sample of missing values, we opted to remove them to preserve the integrity of the data. 

```{r}
cleaned_survey_data = cleaned_survey_data[rowSums(is.na(cleaned_survey_data)) == 0, ] 
```
