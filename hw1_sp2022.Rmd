...
```{r, echo=FALSE}
plot(baseball$diff_log, baseball$win_pct, pch = 16, cex = 1.3, col = "red")
#this plot does not indicate any correlation between increased payroll and increased performance

plot(baseball$payroll, baseball$win_pct, pch = 16, cex = 1.3, col = "blue")
cor(baseball$payroll, baseball$win_pct)
```

The correlation between the log difference of the payrrroll between years and the
