...
knitr::opts_chunk$set(echo = params$printcode, fig.width=8, fig.height=4)
...
print(summary(payData$p2013 - payData$p2012))
print(summary(log(payData$p2013) - log(payData$p2012)))
```
