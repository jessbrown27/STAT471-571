...
dtms$genre <- as.factor(film$genre)
dtm.train <- dtms[sample.index, ]
dtm.test <- dtms[-sample.index, ]
```
```{r, echo = FALSE, results = FALSE}
y <- dtm.train$genre
# temp <- dtm.train
# colnames(temp) <- gsub(x = names(temp), pattern = " ", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "\\.", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "1", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "2", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "3", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "4", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "5", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "6", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "7", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "8", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "9", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "0", replacement = "_")
# colnames(temp) <- gsub(x = names(temp), pattern = "#", replacement = "_")
# temp <- as.data.frame(temp)
# X1 <- sparse.model.matrix(y ~., data = temp)[, -1]
