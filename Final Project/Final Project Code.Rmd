...
I think we should add 1 of two simple regression models and slowly add variables to see what happens and we can write anaylsis of the models and they mean. 
...
Anova(fit1)
```
Based on the ANOVA for this test, we can ese that all of the variables used the the regression are significant. 
