...
```{r}
film.rf <- randomForest(rating~., film.test, mtry=3, ntree=300)
plot(film.rf)
```
...
We used the validation data set to find the validation error of our final model and found that the validation error is `r val.error`.
