...
```
We can see that the correlation between average vote and critics vote is 0.915 which is a very strong positive correlation. From the simple linear regression we can see that when the critics' vote increases by 1 unit we get that the average vote increase by 0.780724 units.
