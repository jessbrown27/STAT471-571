...
$a_{01}/a_{10}=\frac{1}{10}$
$P(HD=1 \mid AGE \cap SEX \cap SBP \cap CHOL)>\frac{\frac{1}{10}}{1+\frac{1}{10}}$
$P(HD=1 \mid AGE \cap SEX \cap SBP \cap CHOL)>0.0909$
$logit > log\frac{.0909}{1-.0909}$
$logit > -2.303$
...
$-8.40872+0.05664AGE+0.98987SEXMALE+0.01696SBP+0.00448CHOL >? -2.303$
$-8.40872+0.05664(50)+0.98987(0)+0.01696(110)+0.00448(180) = -2.905$
