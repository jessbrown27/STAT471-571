...
rf.test.err <- mean(data2.train$yelp_data.rating != predicted_oob)
```
...
data2.train.num$yelp_data.rating <- as.numeric(data2.train.num$yelp_data.rating)
pc <- prcomp(data2.train.num, scale=TRUE)
...
fit.rf.2 <- randomForest(yelp_data.rating~., data3, mtry=3, ntree=50)
predicted_oob.2 <- fit.rf.2$predicted
rf.test.err.2 <- mean(data3$yelp_data.rating != predicted_oob.2)
```
