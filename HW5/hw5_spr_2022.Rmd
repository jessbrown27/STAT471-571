...
We can see that although there are different counts for each weekday and month, the composition of star ratings is about the same, so there doesn't appear to be related to month of the year or day of the week. 
