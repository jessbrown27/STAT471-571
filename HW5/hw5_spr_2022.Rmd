...
predicted_average <- round(((as.numeric(predicted_oob) + as.numeric(predicted_oob.2) - 2) / 2), 0)
predicted_average_err <- mean(data3$rating != predicted_average)
```

The testing error is `r predicted_average_err`.
